 ...
 /*
  * http://www.esp8266.com/viewtopic.php?f=29&t=2226
 * 31 mar 2015
 * This sketch displays date and time from a DAYTIME server.
 * Sketch connects to TCP port 13 from a server in DAYTIME format
 * Expected response lie : 57063 15-02-10 10:04:09 00 0 0 537.1 UTC(NIST) * 
*/
...
Expected return on console:
...
WiFi connected
IP address: 192.168.100.71
connecting to 128.138.141.172

57223 15-07-20 13:12:05 50 0 0 542.1 UTC(NIST) * 
